...
(NAME='OurExercise_Db',FILENAME='D:\simplilearn\phase2\day-1\OurExercise_Db.mdf',
SIZE =16MB ,MAXSIZE=24MB,FILEGROWTH=8MB)
LOG ON 
(NAME ='OurExercise_log',FILENAME ='D:\simplilearn\phase2\day-1\OurExercise_log.ldf')
